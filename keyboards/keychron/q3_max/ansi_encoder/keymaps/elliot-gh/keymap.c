...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_tkl_ansi(
        RST_DLY,  BT_HST1,  BT_HST2,  BT_HST3,  P2P4G,    _______,  _______,  RGB_HUI,  RGB_SAI,  RGB_TOG,  RGB_MOD,  RGB_VAI,  RGB_SPI,    KC_MUTE,    _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    KC_MPLY,  KC_MUTE,  KC_VOLU,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  NK_OFF,   _______,  _______,  _______,    _______,    KC_MPRV,  KC_MNXT,  KC_VOLD,
        RGB_IND,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,              _______,
        _______,            _______,  _______,  _______,  _______,  BAT_LVL,  NK_ON,    _______,  _______,  _______,  _______,              _______,              KC_BRIU,
        _______,  GUI_LOCK, _______,                                _______,                                _______,  _______,  KC_RGUI,    _______,    _______,  KC_BRID,  _______),
